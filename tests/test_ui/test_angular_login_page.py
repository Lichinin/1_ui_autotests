...
class TestAngularLoginPage:
    ...
    def test_password_is_visible(self, pages: PageFactory):
        with allure.step('Открыть стартовую страницу'):
            angular_page = pages.angular_page.open_page()
    ...
    def test_login_button_is_disabled(self, pages: PageFactory):
        with allure.step('Открыть стартовую страницу'):
            angular_page = pages.angular_page.open_page()
    ...
    def test_valid_autorization(self, pages: PageFactory):
    ...
    def test_invalid_autorization(self, pages: PageFactory):
    ...
    def test_logout(self, pages: PageFactory):
        login = Constants.ANGULAR_VALID_LOGIN
        password = Constants.ANGULAR_VALID_PASS
        description = Constants.ANGULAR_VALID_DESC
